...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.js"></script>
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.8/js/select2.min.js"></script>
     ...
     <div class="page-header">
        ...
        <h1 class="page--title">Tambah setoran </h1>
<br>
        <div class="container">
  ...
  <div class="mb-3">
    ...
    @endif
    <label class="form-label" for="exampleFormControlInput1">Akun Tujuan : </label>
  ...
  <div class="mb-3">
  <label for="inputGroupMergeEmail" class="form-label">Bukti Setoran</label>
  ...
  <div class="mb-3">
    @php
        ...
        // };
    @endphp
    {{-- <label class="form-label" for="exampleFormControlInput1">Stock Kue Yang sudah + Terpesan disni Ini : </label> --}}
                ...
                <tr>
                  <td>
                    <select class="theSelect form-select form-select-hover-light" name="id_kue[]">
                      @foreach ($kues as $kue)
                        <option value="{{$kue->cookie->id}}">{{$kue->cookie->nama}} - Limit Terjual - Setoran : {{$kue->terjual - $kue->setoran }}</option>
                      @endforeach
                    </select>
                  </td>
                  <td>
          ...
          function adder(){
             var tr =  `
                  ...
                  <td>
                    <select class="theSelect form-select form-select-hover-light" name="id_kue[]">
                      @foreach ($kues as $kue)
                                                <option value="{{$kue->cookie->id}}">{{$kue->cookie->nama}} - Limit Terjual : {{$kue->terjual - $kue->setoran}}</option>
