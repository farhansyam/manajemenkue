...
<br>
        <div class="container">
          <form action="{{route('droping.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
              <div class="w-md-50">
  <div class="mb-3">
  ...
  <div class="input-group input-group-merge">
    ...
    <input type="file" required class="form-control" id="" name="file" aria-describedby="inputGroupMergeEmailAddOn">
  </div>
</div>
  <div class="mb-3">
    @php
