  ...
  <div class="mb-3">
    <label class="form-label" for="exampleFormControlInput1">Kue : </label>
      ...
      @endforeach
              ...
              <!-- Form -->
              <div class="mb-3">
                <label for="formControlHoverLightFullName" class="form-label">Jumlah Droping</label>
              ...
              <div class="mb-3">
                <label for="formControlHoverLightFullName" class="form-label">Stock</label>

                <input type="number" required name="stock" class="form-control form-control-hover-light" id="formControlHoverLightFullName" value="{{$kue->stock}}" placeholder="Masukan Jumlah">
              </div>
              <!-- End Form -->
              <!-- End Form -->
            </div>
