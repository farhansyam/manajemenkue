...
<form action="{{route('tracksales-id')}}" method="get">
...
<!-- Page Header -->
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col">
            <h1 class="page-header-title">Tracking Sales {{$user->name}}</h1>
            <h1 class="page-header-title">Kode Sales {{$user->kode_sales}}</h1>
          </div>
