...
<br><br><br>
<h3>Tracking Agen</h3>
<form action="{{route('trackkoor-id')}}" method="get">
...
<!-- Page Header -->
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col">
            <h1 class="page-header-title">Tracking Koordinator Sales {{$user->name}}</h1>
            <h1 class="page-header-title">Kode Koordinator Sales {{$user->kode_sales}}</h1>
          </div>
